...
public class Group {
    ...
    private static DateFormat df = new SimpleDateFormat("MM/dd hh:mmaa zzz yyyy");

    private ArrayList<Member> players = new ArrayList<Member>();
    private ArrayList<Member> subs = new ArrayList<Member>();

    public Group(int id, String name, String date, String time, String timezone, Member m) throws ParseException {
        ID = id;
        this.name = name;
